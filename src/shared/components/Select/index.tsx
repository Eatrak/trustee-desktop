    ...
    (
            ...
            if (filteredOptions.length > 0) {
                return filteredOptions.map((option) => {
                    return (
                        ...
                        >
                            <p className="select__option_text paragraph--small">
                                {option.name}
                            </p>
                        </div>
                    );
        ...
        return (
            <div
                ...
                className={
                    "select " +
                    (errors.length > 0 ? "select--error" : "") +
                    (className || "")
                }
                tabIndex={0}
            >
                <p className="paragraph--small paragraph--sub-title select__title">
                    {text}
                </p>
                <div
                ...
                >
                    ...
                    <NormalButton
                        ...
                        iconClass={
                            "select__body__row" +
                            (opened ? " select__body__row--activated" : "")
                        }
                    />
                </div>
                {renderErrors()}
                <div
                    className={
                        "select__options-panel select__options-panel--" +
