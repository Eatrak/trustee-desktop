...
const translation: Translation = {
    fieldNames: {
        ...
        language: "lingua",
        password: "password",
        carriedOut: "effettuato il",
        isIncome: "è un'entrata",
    },
    errors: {
    ...
    modules: {
        ...
        transactions: {
            header: {
                ...
                calendar: {
                    startDate: "Scegli una data di inizio",
                    endDate: "Scegli una data di fine",
                },
            },
            summary: {
                income: "Entrata",
            ...
            table: {
                ...
                deletionDialog: {
                    ...
                    description:
                        'Sei sicuro di voler eliminare la transazione "{{name}}"?',
                    cancel: "Esci",
                    confirm: "Conferma",
                },
            },
...
customZodTranslation.errors.too_small.array.inclusive =
    'Il campo "{{path}}" deve contenere almeno {{minimum}} elemento/i';
